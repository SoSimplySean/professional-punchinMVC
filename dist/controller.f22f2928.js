...
exports.RES_PER_PAGE = exports.CSV = void 0;
...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"js/model.js":[function(require,module,exports) {
"use strict";
...
var pagination__buttons = document.querySelector(".pagination__buttons");
  ...
  _createClass(paginationView, [{
    ...
    value: function render(totalPages, currentPage) {
      ...
      if (currentPage < totalPages) {
        buttons += "<li class=\"pagination__button pagination__next\"><i class=\"bi bi-chevron-right\" data-goto=\"".concat(currentPage + 1, "\"></i></li>");
      }
...
var requestBar = document.querySelector(".request-bar");
var footer = document.querySelector(".footer-container");
var requestButton = document.querySelector(".request-button");
var modalOverlay = document.querySelector(".modal-overlay");
var requestModal = document.querySelector(".request-modal-container");
var projectPageContainer = document.querySelector(".project-page-container"); // REQUEST BAR
...
fixRequestBar = function fixRequestBar(entries) {
  var _entries = _slicedToArray(entries, 1),
      entry = _entries[0];
...
requestObserver.observe(footer); // REQUEST FORM
// Request form - general function to unhide

var showRequestForm = function showRequestForm() {
  modalOverlay.classList.remove("hidden");
  requestModal.classList.remove("hidden");
}; // Request form - general function to hide


var hideRequestForm = function hideRequestForm() {
...
requestBar.addEventListener("click", showRequestForm); // Request form - button activation to hide

modalOverlay.addEventListener("click", hideRequestForm);
document.addEventListener("keydown", function (e) {
  if (e.key === "Escape" && !requestModal.classList.contains("hidden")) hideRequestForm();
});
